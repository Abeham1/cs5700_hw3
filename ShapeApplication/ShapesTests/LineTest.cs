...
namespace ShapesTests
{
    ...
    public class LineTest
    {
        ...
        public void TestComputeSlope()
        {
            ...
            Assert.AreEqual(int.PositiveInfinity, myLine.ComputeSlope(), 0.1);

            myLine = new Line(2, 4, 2, 2);
            Assert.AreEqual(int.NegativeInfinity, myLine.ComputeSlope(), 0.1);

            myLine = new Line(2, 2, 2, 2);
            Assert.IsTrue(int.IsNaN(myLine.ComputeSlope()));
        }
    }
}
